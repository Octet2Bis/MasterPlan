...
description: Manuel opérationnel et standards d'exécution pour agents autonomes inspirés des harnesses de référence mondiaux (SWE-Agent, OpenHands, Aider, Inspect AI, Promptfoo, E2B, Daytona). À utiliser dans 03_Developpement_App_and_Design/ et 01_GTM_Growth/.
---
...
* **Repo-Map Avant Exploration :** Exécuter `python 03_Developpement_App_and_Design/toolbox/repo_mapper.py <dossier>` pour obtenir les signatures de classes et de fonctions sans saturer la fenêtre de contexte.
...
* **Validation d'État :** Exécuter `python 03_Developpement_App_and_Design/toolbox/state_scorer.py` pour valider mathématiquement qu'aucune règle de l'architecture 3 couches n'a été violée.
